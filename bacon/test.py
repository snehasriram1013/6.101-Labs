...
#MY TEST_______________________________________________________________________
def test_tiny():
    #simple test, two actors who had not acted together
    actor1 = 1640
    actor2 = 1532
    assert lab.acted_together(db_tiny, actor1, actor2) is False
#MY TEST ENDS HERE_____________________________________________________________ 
...
#MY TESTS FOR THE BACON NUM FUNCTION __________________________________________

def test_tiny_bacon_num_01():
    first_result = lab.actors_with_bacon_number(db_tiny, 0)
    expected = {4724}
    assert first_result == expected
    
def test_tiny_bacon_num_02():
    first_result = lab.actors_with_bacon_number(db_tiny, 1)
    expected = {2876, 1532}
    assert first_result == expected
    
def test_tiny_bacon_num_03():
    first_result = lab.actors_with_bacon_number(db_tiny, 2)
    expected = {1640}
    assert first_result == expected
    
def test_tiny_bacon_num_04():
    first_result = lab.actors_with_bacon_number(db_tiny, 3)
    expected = set()
    assert first_result == expected
...
#MY TESTS FOR THE BACON PATH FUNCTION_________________________________________
def test_tiny_bacon_path():
    ...
    assert len(result) == len([4724, 2876, 1640])
#MY TEST ENDS HERE_____________________________________________________________ 
...
#MY TEST FOR THE ACTOR TO ACTOR PATH FUNCTION__________________________________
def test_tiny_actor_to_actor():
    x = 2876
    y = 1532
    p = lab.actor_to_actor_path(db_tiny, x, y)
    expected = (2876, 1532)
    for i in range(len(expected)):
        assert expected[i]==p[i]
#MY TEST ENDS HERE_____________________________________________________________        
