...
class Add(BinOp):
    ...
    def simplify(self):
        ...
        return left_simplified + right_simplified
...
class Mul(BinOp):
    ...
    def simplify(self):
        ...
        if right_simplified == Num(0) or left_simplified == Num(0):
            return Num(0)
...
class Pow(BinOp):
    ...
    def deriv(self, x):
        ...
        if isinstance(left, Symbol) and isinstance(right, Num):
            return right * left ** (right - 1) * left.deriv(x)
